...
class PoolItem(TimeStampedModel, Base):
    ...
    feasible_round_trips: Mapped[int] = mapped_column(Integer, nullable=True)
    sell_percentile_used: Mapped[int] = mapped_column(Integer, nullable=True)
    queue_ahead: Mapped[int] = mapped_column(Integer, nullable=True)
    days_to_clear: Mapped[Decimal] = mapped_column(Numeric(10, 1), nullable=True)
...
class TradingSettings(TimeStampedModel, Base):
    ...
    sell_percentile: Mapped[int] = mapped_column(Integer, default=90)
